 ...
 * Escapes included for convenience: `\\,` non\-breaking thin space, `\\O` &#927 Bachmann–Landau notation, \(but really capital omicron because fonts,\) `\\Theta` &#920;, `\\Omega` &#937;, `\\times` &#215;, `&#183;` &#183;\.
 * `~` non\-breaking space;
