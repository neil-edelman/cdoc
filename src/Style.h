...
static const struct StyleText {
	...
	int is_next_level, is_suppress_escapes, is_hug_word;
} no_style = { "nosty", "", "", "", 0, 0, 0 },
plain_text = { "plain", "", " ", "", 0, 0, 0 },
plain_parenthetic = { "paren", "(", " ", ")", 0, 0, 0 },
plain_see_license = { "license", "(See license details ", ", ", ".)", 0, 0, 0 },
plain_csv = { "csv", "", ", ", "", 0, 0, 0 },
plain_ssv = { "ssv", "", "; ", "", 0, 0, 0 },
...
styles[][3] = {
	...
	{ { "", 0, 0, 0, 0, 0, 0 },
		...
		{ "em", "_", "", "_", 0, 0, 0 } },
	{ { "", 0, 0, 0, 0, 0, 0 },
		{ "strong", "<strong>", "", "</strong>", 0, 0, 0 },
		{ "strong", "*", "", "*", 0, 0, 0 } },
	{ { "", 0, 0, 0, 0, 0, 0 },
		{ "codeem", "<em>", "", "</em>", 0, 0, 1 },
		{ "codeem", "`_`", "", "`_`", 0, 0, 1 } },
	{ { "", 0, 0, 0, 0, 0, 0 },
		{ "codeb", "<strong>", "", "</strong>", 0, 0, 1 },
		{ "codeb", "`**`", "", "`**`", 0, 0, 1 } }
};
